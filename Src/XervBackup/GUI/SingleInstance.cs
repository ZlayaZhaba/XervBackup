        ...
        private void m_filewatcher_Created(object sender, System.IO.FileSystemEventArgs e)
        {
            ...
            do
            {
                try
                {
                    ...
                    using (System.IO.StreamReader sr = new System.IO.StreamReader(XervBackup.Library.Utility.Utility.IsClientLinux ? UnixSupport.File.OpenExclusive(e.FullPath, System.IO.FileAccess.ReadWrite) : new System.IO.FileStream(e.FullPath, System.IO.FileMode.Open, System.IO.FileAccess.Read, System.IO.FileShare.None)))
