...
namespace XervBackup.GUI.Wizard_pages.Add_backup
{
    public partial class SelectFiles : WizardControl
    {
        ...
        private void CalculateFolderSize(string folder)
        {
            ...
            long size = XervBackup.Library.Utility.Utility.GetDirectorySize(folder, null);
            lock (m_lock)
                m_sizes[folder] = size;
        }
        ...
        private HelperControls.FolderPathEntry AddFolderControl()
        {
            ...
            try
            {
                ...
                HelperControls.FolderPathEntry entry = new XervBackup.GUI.HelperControls.FolderPathEntry();
