...
namespace XervBackup.GUI.Wizard_pages.RestoreSetup
{
    public partial class FinishedRestoreSetup : WizardControl
    {
        ...
        void FinishedRestoreSetup_PageLeave(object sender, PageChangedArgs args)
        {
            ...
            try
            {
                HelperControls.WaitForOperation dlg = new XervBackup.GUI.HelperControls.WaitForOperation();
        ...
        private void NormalizeApplicationSettings() {
            ...
            if (string.IsNullOrEmpty(appset.StartupDelayDuration) || XervBackup.Library.Utility.Timeparser.ParseTimeSpan(appset.StartupDelayDuration) < TimeSpan.FromMinutes(5))
            {
