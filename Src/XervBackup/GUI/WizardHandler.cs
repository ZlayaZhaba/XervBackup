...
namespace XervBackup.GUI
{
    ...
    public class WizardHandler
    {
        ...
        public WizardHandler(IWizardControl[] pages)
        {
            ...
            m_form.DefaultImage = Properties.Resources.XervBackup;
        ...
        {
            Wizard_pages.WizardSettingsWrapper wrapper = new XervBackup.GUI.Wizard_pages.WizardSettingsWrapper(m_form.Settings);

            if (wrapper.PrimayAction == XervBackup.GUI.Wizard_pages.WizardSettingsWrapper.MainAction.Add || wrapper.PrimayAction == XervBackup.GUI.Wizard_pages.WizardSettingsWrapper.MainAction.Edit)
            {
                ...
                //Resume XervBackup if the backup is supposed to run
                ...
                if (wrapper.PrimayAction == XervBackup.GUI.Wizard_pages.WizardSettingsWrapper.MainAction.Add)
