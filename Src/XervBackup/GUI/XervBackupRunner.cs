...
using XervBackup.Library.Main;

namespace XervBackup.GUI
{
    /// <summary>
    /// This class translates tasks into XervBackup calls, and executes them
    /// </summary>
    public class XervBackupRunner : XervBackup.Library.Main.LiveControl.ILiveControl
    {
        ...
        public delegate void ProgressEventDelegate(XervBackupOperation operation, RunnerState state, string message, string submessage, int progress, int subprogress);
        ...
        private XervBackupOperation m_lastPGOperation;
        private XervBackupOperationMode m_lastPGMode;
        ...
        {
            XervBackup_OperationProgress(null, m_lastPGOperation, m_lastPGMode, m_lastPGProgress, m_lastPGSubprogress, m_lastPGmessage, m_lastPGSubmessage );
        }
