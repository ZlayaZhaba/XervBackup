...
namespace XervBackup.Datamodel
{
    public class ApplicationSettings
    {
        ...
        /// <summary>
        /// Returns the default XervBackup temp path
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating if XervBackup should apply a common password to backups
        /// </summary>
        ...
        /// <summary>
        /// Returns the default XervBackup signature cache path
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the amount of time XervBackup will be paused after startup
        /// </summary>
        ...
        public bool HideDonateButton
        {
            get
            {
                ...
                return XervBackup.Library.Utility.Utility.ParseBool(tmp, false);
            }
