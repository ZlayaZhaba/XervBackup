...
/// <provider name="System.Data.LightDatamodel.SQLiteDataProvider" connectionstring="Version=3;Data Source=D:\Dokumenter\XervBackup\XervBackup\GUI\Datamodel\XervBackup.sqlite;" />
/// <type>Table</type>
...
namespace XervBackup.Datamodel
{
	...
	[DatabaseTable("TaskExtension")]
	public partial class TaskExtension : DataClassBase
	{
...
#region " private members "
		...
		[Relation("TaskExtensionTask", typeof(Task), "ID"), DatabaseField("TaskID")]
...
#region " referenced properties "
		...
		public Task Task
		{
			get{ return ((DataFetcherWithRelations)m_dataparent).GetRelatedObject<Task>("TaskExtensionTask", this); }
			set{ ((DataFetcherWithRelations)m_dataparent).SetRelatedObject("TaskExtensionTask", this, value); }
		}
