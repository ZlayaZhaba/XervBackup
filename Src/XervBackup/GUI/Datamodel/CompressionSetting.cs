...
/// <provider name="System.Data.LightDatamodel.SQLiteDataProvider" connectionstring="Version=3;Data Source=D:\Documents\XervBackup\gpg-commandline-settings\XervBackup\GUI\Datamodel\XervBackup.sqlite;" />
/// <type>Table</type>
/// <namespace>XervBackup.Datamodel</namespace>
...
namespace XervBackup.Datamodel
{
	...
	[DatabaseTable("CompressionSetting")]
	public partial class CompressionSetting : DataClassBase
	{
...
#region " private members "
		...
		[Relation("CompressionSettingTask", typeof(Task), "ID"), DatabaseField("TaskID")]
...
#region " referenced properties "
		...
		public Task Task
		{
			get{ return ((DataFetcherWithRelations)m_dataparent).GetRelatedObject<Task>("CompressionSettingTask", this); }
			set{ ((DataFetcherWithRelations)m_dataparent).SetRelatedObject("CompressionSettingTask", this, value); }
		}
