...
namespace XervBackup.GUI.HelperControls
{
    public partial class CommandLineOptionGrid : UserControl
    {
        ...
        private XervBackup.Library.Interface.ICommandLineArgument GetArgument(DataRow r)
        {
            ...
            else if (v is XervBackup.Library.Interface.ICommandLineArgument)
                return (XervBackup.Library.Interface.ICommandLineArgument)v;
            else
                return null;
        }
        ...
        private void OptionsGrid_RowValidating(object sender, DataGridViewCellCancelEventArgs e)
        {
            ...
            if ((bool)r["Enabled"])
            {
                ...
                string validationMessage = XervBackup.Library.Main.Interface.ValidateOptionValue(arg, arg.Name, optionvalue);
        ...
        private void OptionsGrid_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
        {
            ...
            if (m_enabledClicked && e.ColumnIndex == 0 && e.FormattedValue.ToString() == true.ToString())
            {
                ...
                Library.Interface.ICommandLineArgument arg = GetArgument(r);
                if (arg.Type == XervBackup.Library.Interface.CommandLineArgument.ArgumentType.Boolean)
                {
