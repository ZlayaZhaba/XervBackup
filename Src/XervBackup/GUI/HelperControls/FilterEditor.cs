...
namespace XervBackup.GUI.HelperControls
{
    /// <summary>
    ...
    public partial class FilterEditor : UserControl
    {
        ...
        private string EncodeAsFilter(List<FilterDialog.FilterEntry> items)
        {
            ...
            return XervBackup.Library.Utility.FilenameFilter.EncodeAsFilter(r);
        }
        ...
        private void FilenameTester_TextChanged(object sender, EventArgs e)
        {
            ...
            while (folder.Length > basepath.Length)
            {
                ...
                parentFolders.Add(XervBackup.Library.Utility.Utility.AppendDirSeparator(folder));
            }
            ...
            Library.Utility.FilenameFilter fn = new XervBackup.Library.Utility.FilenameFilter(XervBackup.Library.Utility.FilenameFilter.DecodeFilter(compact));
        ...
        {
            XervBackup.Library.Utility.UrlUtillity.OpenUrl("http://code.google.com/p/XervBackup/wiki/FilterUsage");
        }
        ...
        private void IncludeFolderButton_Click(object sender, EventArgs e)
        {
            ...
            {
                string path = XervBackup.Library.Utility.Utility.AppendDirSeparator(folderBrowserDialog.SelectedPath);
                FilterDialog.FilterEntry fe = new FilterDialog.FilterEntry(true, XervBackup.Library.Utility.FilenameFilter.ConvertGlobbingToRegExp(path), path);
        ...
        private void ExcludeFolderButton_Click(object sender, EventArgs e)
        {
            ...
            {
                string path = XervBackup.Library.Utility.Utility.AppendDirSeparator(folderBrowserDialog.SelectedPath);
                FilterDialog.FilterEntry fe = new FilterDialog.FilterEntry(false, XervBackup.Library.Utility.FilenameFilter.ConvertGlobbingToRegExp(path), path);
                listView.Items.Add(fe.CreateListViewItem());
                FilenameTester_TextChanged(sender, e);
            }
        }
