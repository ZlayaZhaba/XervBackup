...
namespace XervBackup.Library.Utility
{
    /// <summary>
    /// Class for wrapping a <see cref="XervBackup.Library.Utility.BlockingQueue"/> as an <see cref="System.Collections.Generic.IEnumerable"/>
    /// </summary>
    ...
    public class BlockingQueue<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XervBackup.Library.Utility.BlockingQueue"/> class with the default capacity
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="XervBackup.Library.Utility.BlockingQueue"/> is completed
        /// </summary>
        public bool Completed { get { return m_completed; } }

        /// <summary>
        /// Initializes a new instance of the <see cref="XervBackup.Library.Utility.BlockingQueue"/> class
        /// </summary>
