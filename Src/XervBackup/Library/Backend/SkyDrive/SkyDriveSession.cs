...
namespace XervBackup.Library.Backend
{
    ...
    public class SkyDriveSession : IDisposable
    {
        ...
        /// </summary>
        private readonly static string USER_AGENT = "XervBackup SkyDrive client v" + System.Reflection.Assembly.GetExecutingAssembly().GetName().Version.ToString();
        ...
        public HttpWebResponse DownloadFile(string remotename)
        {
            ...
            */
            ...
            // but it works with -_. and that should be enough for XervBackup
