...
namespace XervBackup.Library.Interface
{
    ...
    public class CommonStrings
    {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The connection succeeded but another backup was found in the destination folder. It is possible to configure XervBackup to store multiple backups in the same folder, but it is not recommended.
        ///
