...
namespace XervBackup.Library.Interface
{
    ...
    /// At this point the control should setup the XervBackup options, based on the saved userinterface state.
    ...
    public interface IGUIControl
    {
        ...
        /// <summary>
        /// This method sets up the XervBackup options, based on a previous setup.
        ...
        /// <param name="commandlineOptions">A set of commandline options passed to XervBackup</param>
