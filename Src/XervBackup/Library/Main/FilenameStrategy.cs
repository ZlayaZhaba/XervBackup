...
namespace XervBackup.Library.Main
{
    ...
    internal class FilenameStrategy
    {
        ...
        //In XervBackup 1.0 there is only one manifest file, and it is called manifest or M in short mode
        ...
        //Future versions of XervBackup always verify the version number to avoid reading/writing data to a format 
