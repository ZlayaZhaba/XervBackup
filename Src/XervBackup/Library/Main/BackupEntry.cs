...
namespace XervBackup.Library.Main
{
    ...
    internal class Sorter 
        : IComparer<BackupEntryBase>, 
            ...
            IComparer<XervBackup.Library.Interface.IFileEntry>
    {
    ...
    public abstract class BackupEntryBase
    {
        ...
        protected XervBackup.Library.Interface.IFileEntry m_fileentry;
        ...
        /// </summary>
        public XervBackup.Library.Interface.IFileEntry Fileentry { get { return m_fileentry; } }
        /// <summary>
        ...
        protected BackupEntryBase(string filename, XervBackup.Library.Interface.IFileEntry entry, DateTime time, bool isFull, string timeString, string encryption)
        {
            m_filename = filename;
            m_fileentry = entry;
            if (entry != null)
    ...
    {
        public DeleteTransactionEntry(XervBackup.Library.Interface.IFileEntry entry, string encryption)
    ...
    {
        public VerificationEntry(string filename, XervBackup.Library.Interface.IFileEntry entry, DateTime time, string timestring)
    ...
    public class ManifestEntry : BackupEntryBase
    {
        ...
        public ManifestEntry(string filename, XervBackup.Library.Interface.IFileEntry entry, DateTime time, bool isFull, string timeString, string encryption, bool primary)
    ...
    public abstract class PayloadEntryBase : BackupEntryBase
    {
        ...
        protected PayloadEntryBase(string filename, XervBackup.Library.Interface.IFileEntry entry, DateTime time, bool isFull, string timeString, string encryption, string compression, int volumenumber)
            : base(filename, entry, time, isFull, timeString, encryption)
        {
    ...
    {
        public SignatureEntry(string filename, XervBackup.Library.Interface.IFileEntry entry, DateTime time, bool isFull, string timeString, string encryption, string compression, int volumenumber)
    ...
    {
        public ContentEntry(string filename, XervBackup.Library.Interface.IFileEntry entry, DateTime time, bool isFull, string timeString, string encryption, string compression, int volumenumber)
            : base(filename, entry, time, isFull, timeString, encryption, compression, volumenumber)
        {
        }
