...
namespace XervBackup.Library.Main.StateVerification
{
    /// <summary>
    ...
    /// </summary>
    public class StateDatabase : XervBackup.Library.Interface.IBackendInteraction, IEnumerable<LogEntryBase>
    {
        ...
        public StateDatabase(string filename, CommunicationStatistics stats)
        {
            ...
            {
                XmlSerializer s = new XmlSerializer(typeof(List<InvocationCollection>), new XmlRootAttribute("XervBackup-state-db"));
        ...
        public void RegisterGet(XervBackup.Library.Interface.IFileEntry entry, bool success, String errorMessage)
        {
        ...
        public void RegisterDelete(XervBackup.Library.Interface.IFileEntry entry, bool success, String errorMessage)
        {
        ...
        public void RegisterPut(XervBackup.Library.Interface.IFileEntry entry, bool success, String errorMessage)
        {
        ...
        public void RegisterList(List<XervBackup.Library.Interface.IFileEntry> files, bool success, String errorMessage) 
        {
