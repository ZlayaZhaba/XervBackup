...
{
    public class ConsolePasswordInput : XervBackup.Library.Interface.IGenericModule
    {
        /// <summary>
        ...
        public IList<XervBackup.Library.Interface.ICommandLineArgument> SupportedCommands { get { return null; } }
