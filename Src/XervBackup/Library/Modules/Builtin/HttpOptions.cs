...
namespace XervBackup.Library.Modules.Builtin
{
    public class HttpOptions : XervBackup.Library.Interface.IGenericModule, IDisposable
    {
        ...
        public IList<XervBackup.Library.Interface.ICommandLineArgument> SupportedCommands
        {
            get { 
                return new List<XervBackup.Library.Interface.ICommandLineArgument>( new XervBackup.Library.Interface.ICommandLineArgument[] {
                    new XervBackup.Library.Interface.CommandLineArgument(OPTION_DISABLE_EXPECT100, XervBackup.Library.Interface.CommandLineArgument.ArgumentType.Boolean, Strings.HttpOptions.DisableExpect100Short, Strings.HttpOptions.DisableExpect100Long, "false"),
                    new XervBackup.Library.Interface.CommandLineArgument(OPTION_DISABLE_NAGLING, XervBackup.Library.Interface.CommandLineArgument.ArgumentType.Boolean, Strings.HttpOptions.DisableNagleShort, Strings.HttpOptions.DisableNagleLong, "false"),
                    new XervBackup.Library.Interface.CommandLineArgument(OPTION_ACCEPT_SPECIFIED_CERTIFICATE, XervBackup.Library.Interface.CommandLineArgument.ArgumentType.String, Strings.HttpOptions.DescriptionAcceptHashShort, Strings.HttpOptions.DescriptionAcceptHashLong),
                    new XervBackup.Library.Interface.CommandLineArgument(OPTION_ACCEPT_ANY_CERTIFICATE, XervBackup.Library.Interface.CommandLineArgument.ArgumentType.Boolean, Strings.HttpOptions.DescriptionAcceptAnyCertificateShort, Strings.HttpOptions.DescriptionAcceptAnyCertificateLong),
                }); 
            }
        }
