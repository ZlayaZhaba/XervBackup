...
# 
# Input is always:
#  $1 = name of the snapshot, a random name, same as given to create-lvm-snapshot, usually something like "XervBackup-0102030011234567"
...
#  $3 = name of the temporary folder reported by create-lvm-snapshot, usually "/tmp/XervBackup-0102030011234567"
