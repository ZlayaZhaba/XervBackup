...
namespace XervBackup.Library.Snapshots
{
    /// <summary>
    ...
    public interface ISnapshotService : IDisposable
    {
        ...
        void EnumerateFilesAndFolders(XervBackup.Library.Utility.Utility.EnumerationCallbackDelegate callback);
        ...
        /// <param name="callback">The callback to invoke with each found path</param>
        void EnumerateFilesAndFolders(string startpath, XervBackup.Library.Utility.Utility.EnumerationCallbackDelegate callback);
