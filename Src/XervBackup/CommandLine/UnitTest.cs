...
using System.Text;
using XervBackup.Library.Logging;
using XervBackup.Library.Utility;

namespace XervBackup.CommandLine
{
    /// <summary>
    /// This class encapsulates a simple method for testing the correctness of XervBackup.
    /// </summary>
    public class UnitTest
    {
        ...
        {
            StringComparison sc = XervBackup.Library.Utility.Utility.ClientFilenameStringComparision;
