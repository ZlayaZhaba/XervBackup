...
namespace XervBackup.CommandLine
{
    public static class Help
    {
        ...
        private const string RESOURCE_NAME = "XervBackup.CommandLine.help.txt";
        ...
        private static void PrintArgumentIfFound(IEnumerable<XervBackup.Library.Interface.ICommandLineArgument> args, string topic, List<string> lines)
        {
            if (args == null)
                return;

            foreach (XervBackup.Library.Interface.ICommandLineArgument arg in args)
            {
        ...
        private static void PrintCompressionModule(XervBackup.Library.Interface.ICompression mod, List<string> lines)
        {
            lines.Add(mod.DisplayName + " (." + mod.FilenameExtension + "):");
            lines.Add(" " + mod.Description);
            if (mod.SupportedCommands != null && mod.SupportedCommands.Count > 0)
        ...
        private static string PrintArguments(IEnumerable<XervBackup.Library.Interface.ICommandLineArgument> args)
        {
            if (args == null)
                return "";
        ...
        private class Matcher
        {
            ...
            public string MathEvaluator(System.Text.RegularExpressions.Match m)
            {
                ...
                XervBackup.Library.Interface.ICommandLineArgument arg;
        ...
        private static string PrintArgsSimple(IEnumerable<XervBackup.Library.Interface.ICommandLineArgument> args)
        {
            if (args == null)
                return "";
