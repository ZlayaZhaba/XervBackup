...
namespace XervBackup.Scheduler
{
    ...
    public partial class SettingsDialog : Form
    {
        ...
        /// Edited settings
        /// </summary>
        public XervBackup.Scheduler.Data.SchedulerDataSet.SettingsDataTable Settings { get; private set; }
        /// <summary>
        /// XML prior to edit
        /// </summary>
        ...
        private void OKButton_Click(object sender, EventArgs e)
        {
            ...
            if (OriginalXML != XmlFromTable(this.Settings))
            {
                ...
                ((XervBackup.Scheduler.Data.SchedulerDataSet)this.Settings.DataSet).Save();
            }
