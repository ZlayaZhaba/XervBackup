...
namespace XervBackup.Scheduler
{
    ...
    public partial class JobDialog : Form
    {
        ...
        /// </summary>
        public XervBackup.Scheduler.Data.SchedulerDataSet.JobsRow Row { get; private set; }
        /// <summary>
        /// Gets the settings
        /// </summary>
        private XervBackup.Scheduler.Data.SchedulerDataSet.SettingsDataTable Settings
        {
            get { return ((XervBackup.Scheduler.Data.SchedulerDataSet)Row.Table.DataSet).Settings; }
        }
        /// <summary>
        ...
        private XervBackup.Scheduler.Data.SchedulerDataSet.JobsRow GetNewRow()
        {
            XervBackup.Scheduler.Data.SchedulerDataSet.JobsRow NewRow = null;
            // The table will die, yet the row lives on...
            using (XervBackup.Scheduler.Data.SchedulerDataSet.JobsDataTable TempTable = new XervBackup.Scheduler.Data.SchedulerDataSet.JobsDataTable())
            {
