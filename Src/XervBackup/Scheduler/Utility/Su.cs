...
namespace XervBackup.Scheduler.Utility
{
    public class Su
    {
        ...
        {
            return Impersonate(aUserName, XervBackup.Scheduler.Utility.User.UserDomain);
        }
        ...
        public static Exception Impersonate(string aUserName, string aDomainName, System.Security.SecureString aPass)
        {
            ...
            try
            {
                ...
                string domainName = string.IsNullOrEmpty( aDomainName ) ? XervBackup.Scheduler.Utility.User.UserDomain : aDomainName;
