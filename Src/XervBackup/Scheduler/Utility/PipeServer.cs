...
namespace XervBackup.Scheduler.Utility
{
    public class PipeServer
    {
        ...
        public void Close()
        {
            ...
            if (itsWriter != null) XervBackup.Scheduler.Utility.Tools.TryCatch((Action)delegate() { itsWriter.Close(); });
            if (itsPipes != null) XervBackup.Scheduler.Utility.Tools.TryCatch((Action)delegate() { itsPipes.Close(); }); 
        }
