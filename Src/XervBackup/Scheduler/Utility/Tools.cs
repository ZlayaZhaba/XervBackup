...
namespace XervBackup.Scheduler.Utility
{
    public static class Tools
    {
        ...
        public static byte[] SecureProtect(System.Security.SecureString aValue)
        {
            ...
            return XervBackup.Scheduler.Utility.Tools.Protect(System.Text.ASCIIEncoding.ASCII.GetBytes(
        ...
        {
            XervBackup.Scheduler.Utility.User.GetApplicationDirectory(aPackage);
            return XervBackup.Scheduler.Utility.User.GetApplicationDirectory(System.IO.Path.Combine(aPackage, "Logs"));
        }
        /// <summary>
        ...
        public static void ProcessError(string aPackage, string aName, Exception aEx, bool aShowDialog, string aLogFile)
        {
            ...
            bool OK = XervBackup.Scheduler.Utility.Tools.NoException((Action)delegate()
            {
