...
namespace XervBackup.Scheduler
{
    ...
    public partial class LogView : Form
    {
        ...
        {
            this.Text = aJobName;
            this.historyDataSet = new XervBackup.Scheduler.Data.HistoryDataSet();
        ...
        {
            e.Value = XervBackup.Library.Utility.Utility.FormatSizeString((long)e.Value);
        }
        /// <summary>
        ...
        private void historyBindingSource_CurrentChanged(object sender, EventArgs e)
        {
            ...
            XervBackup.Scheduler.Data.HistoryDataSet.HistoryRow Row = 
                (XervBackup.Scheduler.Data.HistoryDataSet.HistoryRow)((DataRowView)this.historyBindingSource.Current).Row;
            ...
            if (string.IsNullOrEmpty(LogFile) || !System.IO.File.Exists(LogFile))
                ...
                this.logListBindingSource.DataSource = new XervBackup.Library.Logging.AppendLog.LogList(
        ...
        /// </summary>
        private Dictionary<XervBackup.Library.Logging.LogMessageType, Image> TypeIcons = new Dictionary<XervBackup.Library.Logging.LogMessageType, Image>()
        {
            { XervBackup.Library.Logging.LogMessageType.Error, Bitmap16(System.Drawing.SystemIcons.Error) },
            { XervBackup.Library.Logging.LogMessageType.Information, Bitmap16(System.Drawing.SystemIcons.Information) },
            { XervBackup.Library.Logging.LogMessageType.Profiling, Bitmap16(System.Drawing.SystemIcons.Question) },
            { XervBackup.Library.Logging.LogMessageType.Warning, Bitmap16(System.Drawing.SystemIcons.Warning) },
        };
        /// <summary>
        ...
        private void logListDataGridView_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            {
                e.Value = this.TypeIcons[(XervBackup.Library.Logging.LogMessageType)e.Value];
        ...
        private void logListDataGridView_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ed.ShowDialog(
                ...
                this.TypeIcons[(XervBackup.Library.Logging.LogMessageType)
