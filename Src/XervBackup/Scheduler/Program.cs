...
{
    /// <summary>
    /// The XervBackup Scheduler - Uses the Task Scheduler to run XervBackup Backups
    /// </summary>
    static class Program
    {
        ...
        /// </summary>
        public const string Name = "XervBackup.Scheduler";
        /// <summary>
        ...
        /// </summary>
        public const string PipeServerThreadName = "XervBackup.PipeServer";
        /// <summary>
            ...
            using (System.Threading.Mutex Single = new System.Threading.Mutex(true, Name, out SingleInstance))
            {
                if (SingleInstance)
                {
...
#endif
                    {
                        ...
                        if (System.IO.File.Exists(XervBackup.Scheduler.Data.SchedulerDataSet.DefaultPath()) &&
                            new System.IO.FileInfo(XervBackup.Scheduler.Data.SchedulerDataSet.DefaultPath()).IsReadOnly &&
                            MessageBox.Show("The database file, "+XervBackup.Scheduler.Data.SchedulerDataSet.DefaultPath()+" is not writable by "+Utility.User.UserName+"; continue?", "READONLY", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == DialogResult.No) 
                            return;
                    ...
                    {
                        Utility.Tools.ProcessError("XervBackup", Name, Ex);
                    }
#endif
                }
            }
