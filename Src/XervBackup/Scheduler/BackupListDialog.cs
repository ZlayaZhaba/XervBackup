...
namespace XervBackup.Scheduler
{
    public partial class BackupListDialog : Form
    {
        ...
        private void ContentsToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            itsOptions["restore-time"] = ((this.treeView1.SelectedNode == null) ? DateTime.Now :
                ((XervBackup.Library.Main.ManifestEntry)this.treeView1.SelectedNode.Tag).Time).ToString("s"); // should be "o"
    ...
    public class NodeSorter : System.Collections.IComparer
    {
        ...
        public int Compare(object x, object y)
        {
            ...
            return DateTime.Compare(((XervBackup.Library.Main.ManifestEntry)tx.Tag).Time, ((XervBackup.Library.Main.ManifestEntry)ty.Tag).Time);
        }
    }
}
