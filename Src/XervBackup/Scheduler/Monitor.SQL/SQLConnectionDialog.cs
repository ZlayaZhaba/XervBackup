...
namespace XervBackup.Scheduler.Monitor.SQL
{
    ...
    public partial class SQLConnectionDialog : Form
    {
        ...
        public SQLConnectionDialog(string aHomeConnectionXMLFile)
        {
            ...
            this.ConnectionString = new XervBackup.Scheduler.Data.ConnectionFromXML().ConnectionString(aHomeConnectionXMLFile);
        }
        /// <summary>
        ...
        private void OKButton_Click(object sender, EventArgs e)
        {
            ...
            {
                // Save the result
                new XervBackup.Scheduler.Data.ConnectionFromXML().SaveConnection(this.HomeConnectionXMLFile,
