...
If XervBackup is producing a backup with the option --create-verification-file,
...
if __name__ == "__main__":
	if len(sys.argv) != 1 and len(sys.argv) != 2:
		...
		print "XervBackupVerify.py <path to verification file>"
		print "XervBackupVerify.py <folder with verification files>"
		print "XervBackupVerify.py (no arguments, uses current dir)"
	else:
		if len(sys.argv) == 1:
			argument = os.getcwd()
		else:
