...
namespace XervBackup_Test {
    ...
    internal static class Utils {
        internal const string TEST_DB = "XervBackup_Test.sqlite";
        ...
        internal static System.Data.IDbConnection CreateDbConnection() {
            return (System.Data.IDbConnection) Activator.CreateInstance(XervBackup.Server.SQLiteLoader.SQLiteConnectionType);
        }
