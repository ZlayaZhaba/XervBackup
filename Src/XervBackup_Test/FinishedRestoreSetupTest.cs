...
using XervBackup.GUI;
using XervBackup.Library.Main;
using XervBackup.Library.Utility;
using XervBackup.Datamodel;
using XervBackup.Server;
using XervBackup.GUI.Wizard_pages.RestoreSetup;

namespace XervBackup_Test
{
    // Tests XervBackup.GUI.Wizard_pages.RestoreSetup.FinishedRestoreSetup
    [TestFixture()]
	public class FinishedRestoreSetupTest : BaseBackupTest
    {
        ...
        protected void performBackup()
        {
            ...
            //XervBackup.GUI.Program.UseDatabaseEncryption = false;
