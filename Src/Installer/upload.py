...
def main():
  ...
  for testfile in glob.glob( os.path.join(source_folder, 'XervBackup *.zip') ):
    version_info = testfile[testfile.rfind('XervBackup ') + len('XervBackup '):- len('.zip')]
  ...
  summary_base = "XervBackup " + file_version
  filename_base = "XervBackup " + file_version
  ...
  if (os.path.exists(filename_zip)):
    ...
    os.system('python googlecode_upload.py --summary="' + summary_base + ' - Binaries" --project="XervBackup" --labels="Type-Archive,OpSys-All" "' + filename_zip + '" --user="' + username + '" --password="' + password + '"')
    upload_count+=1

  if (os.path.exists(filename_msi_x86)):
    sys.stdout.write('Uploading file: ' + filename_msi_x86 + '\n')  
    os.system('python googlecode_upload.py --summary="' + summary_base + ' - Windows" --project="XervBackup" --labels="Type-Installer,OpSys-Windows" "' + filename_msi_x86 + '" --user="' + username + '" --password="' + password + '"')
    upload_count+=1

  if (os.path.exists(filename_msi_x64)):
    sys.stdout.write('Uploading file: ' + filename_msi_x64 + '\n')  
    os.system('python googlecode_upload.py --summary="' + summary_base + ' - Windows 64bit" --project="XervBackup" --labels="Type-Installer,OpSys-Windows" "' + filename_msi_x64 + '" --user="' + username + '" --password="' + password + '"')
    upload_count+=1

  if (os.path.exists(filename_deb)):
    sys.stdout.write('Uploading file: ' + filename_deb + '\n')  
    os.system('python googlecode_upload.py --summary="' + summary_base + ' - Debian package" --project="XervBackup" --labels="Type-Installer,OpSys-Linux" "' + filename_deb + '" --user="' + username + '" --password="' + password + '"')
    upload_count+=1

  if (os.path.exists(filename_rpm)):
    sys.stdout.write('Uploading file: ' + filename_rpm + '\n')  
    os.system('python googlecode_upload.py --summary="' + summary_base + ' - Fedora package" --project="XervBackup" --labels="Type-Installer,OpSys-Linux" "' + filename_rpm + '" --user="' + username + '" --password="' + password + '"')
    upload_count+=1

  if (os.path.exists(filename_dmg)):
    sys.stdout.write('Uploading file: ' + filename_dmg + '\n')  
    os.system('python googlecode_upload.py --summary="' + summary_base + ' - Mac OSX image" --project="XervBackup" --labels="Type-Installer,OpSys-OSX" "' + filename_dmg + '" --user="' + username + '" --password="' + password + '"')
    upload_count+=1
	
  if (os.path.exists(filename_tgz)):
    sys.stdout.write('Uploading file: ' + filename_tgz + '\n')  
    os.system('python googlecode_upload.py --summary="' + summary_base + ' - Linux tgz package" --project="XervBackup" --labels="Type-Installer,OpSys-Linux" "' + filename_tgz + '" --user="' + username + '" --password="' + password + '"')
    upload_count+=1
